    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".btns").click(function () {
                ...
                else if(!confirm("确定查询【宠物名称："+name+"】吗?"))
                    return false;
            })
            $(".btns1").click(function () {
                ...
                else if(!confirm("确定查询【主人名称："+master+"】吗?"))
                    return false;
            })
        })
    </script>
...
<form action="PetServlet" method="post">
    <input type="hidden" name="method" value="InquireByN">
    <center>
        <label>宠物名称：</label>
        <input type="text" maxlength="27" placeholder="请输入宠物名称" class="inputText4" size="100" value=""  name="name">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<form action="PetServlet" method="post">
    <input type="hidden" name="method" value="InquireByM">
    <center>
        <br><br> <br>
        <label> 主人名字：</label>
        <input type="text" maxlength="27" placeholder="请输入主人名称" class="inputText4" size="100" value=""  name="master">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
